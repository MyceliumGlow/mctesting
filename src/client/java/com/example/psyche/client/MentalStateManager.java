...
public final class MentalStateManager {
    ...
    public static void tick(MinecraftClient client) {
        ...
        if (client.world.getLightLevel(BlockPos.ofFloored(player.getPos())) <= 4) delta += 0.018;
        if (client.world.getLightLevel(BlockPos.ofFloored(player.getPos())) >= 13) delta -= 0.015;
